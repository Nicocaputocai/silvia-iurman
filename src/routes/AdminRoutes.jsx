...
import EditModule from "../Components/Admin/AdminModules/EditModule";
  ...
  return (
    <Routes>
      <Route path="/*">
        ...
        <Route path="editar-actividad/:id" element={<EditActivity />} />

        <Route path="editar-articulo/:id" element={<EditArticle />} />

        <Route path="editar-curso/:id" element={<EditCourse />} />
        <Route path="administrar-inscripto/:id" element={<EditPurchase />} />
        <Route path="editar-modulo/:id" element={<EditModule />} />
      </Route>
    </Routes>
  );
};
