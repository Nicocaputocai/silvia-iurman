  ...
  const retrieveActivity = async () => {
    ...
    try {
      ...
      reset({
        ...data.activity,
        day:
          data.activity.day.split(":")[0] +
          ":" +
          data.activity.day.split(":")[1],
      });
    } catch (error) {
      console.log(error);
    }
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          const response = await activitiesDataServices.editActivity(
            id,
      ...
      <Form onSubmit={handleSubmit(save)}>
        ...
        <Form.Group controlId="img">
          ...
          {selectedImage ? (
            ...
            <Image
              src={`https://api.silviaiurman.com/img/${editActivity?.data.img}`}
              fluid="true"
            ></Image>
          )}
        </Form.Group>
